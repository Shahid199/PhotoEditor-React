...
fileInput.addEventListener("change", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var _fileInput$files, file, image;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _fileInput$files = _slicedToArray(fileInput.files, 1), file = _fileInput$files[0]; // displaying the uploaded image
...
sizeElement.oninput = function (e) {
  size = e.target.value;
};
var colorElement = document.getElementsByName("colorRadio");
var color;
colorElement.forEach(function (c) {
